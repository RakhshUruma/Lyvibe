...
export const PRESETS: Record<string, Mood> = {
  ...
  flame: base({
    ...
    sceneElements: [{
      // big glowing energy ribbon — S-curved stroke, heavy blur+glow.
      // Looks like a flowing lick of fire, not a literal flame icon.
      shape: "svg",
      svgPath: "M2,36 C12,28 14,16 22,12 C30,8 36,4 38,2",
      svgViewBox: "0 0 40 40",
      strokeOnly: true,
      stroke: "#ffd23f",
      strokeWidth: 3,
      filter: "blur(1.5px) drop-shadow(0 0 8px #ff7f30) drop-shadow(0 0 18px #ff3030)",
      sizeRange: [80, 180], count: 8, spawnRate: 1.4,
      motion: { type: "rise", durationRange: [3.2, 5.5], sineAmplitude: 80, sinePeriod: 1300 },
      selfAnim: { property: "rotate", range: [-25, 25], periodMs: 1100 },
      opacityRange: [0.5, 0.9], blendMode: "screen",
    }, {
      // counter-curving inner wisps (different curvature for visual variety)
      shape: "svg",
      svgPath: "M38,38 C28,32 22,22 16,18 C10,14 6,10 2,4",
      svgViewBox: "0 0 40 40",
      strokeOnly: true,
      stroke: "#ff7f30",
      strokeWidth: 2.4,
      filter: "blur(2px) drop-shadow(0 0 12px #ff3030)",
      sizeRange: [60, 140], count: 6, spawnRate: 1.0,
      motion: { type: "rise", durationRange: [3.5, 6], sineAmplitude: 90, sinePeriod: 1600 },
      selfAnim: { property: "rotate", range: [20, -20], periodMs: 1400 },
      opacityRange: [0.4, 0.8], blendMode: "screen",
    }, {
      // tiny ember sparks
      shape: "svg",
      ...
      sizeRange: [3, 7], count: 50, spawnRate: 4,
      motion: { type: "rise", durationRange: [1.8, 3.2], sineAmplitude: 26, sinePeriod: 800 },
      selfAnim: { property: "scale", range: [0.5, 1.1], periodMs: 500 },

...
const base = (over: Partial<Mood>): Mood => ({
  ...
  bgKeyframes: [],
  useTypewriter: true,
  typewriter: { reveal: "rise", stagger: 0.05, charDuration: "0.42s" },
  sceneElements: [],
  ...over,
});
...
export const PRESETS: Record<string, Mood> = {
  cyber: base({
    ...
    typewriter: { reveal: "type", stagger: 0.025, charDuration: "0.18s" },
  ...
  dream: base({
    ...
    typewriter: { reveal: "blur", stagger: 0.06, charDuration: "0.7s" },
  ...
  mono: base({
    ...
    typewriter: { reveal: "type", stagger: 0.05, charDuration: "0.12s" },
  ...
  neon: base({
    ...
    typewriter: { reveal: "scale", stagger: 0.04, charDuration: "0.32s" },
  ...
  vhs: base({
    ...
    typewriter: { reveal: "type", stagger: 0.035, charDuration: "0.16s" },
  ...
  zen: base({
    ...
    typewriter: { reveal: "fade", stagger: 0.07, charDuration: "0.5s" },
  ...
  aurora: base({
    ...
    typewriter: { reveal: "blur", stagger: 0.08, charDuration: "0.7s" },
    entryKeyframes: k("fade", "slideUp", "emerge"),
    motionKeyframes: m("breathe", "drift", "sway"),
  ...
  forest: base({
    ...
    typewriter: { reveal: "fade", stagger: 0.06, charDuration: "0.5s" },
    entryKeyframes: k("fade", "slideUp", "emerge"),
  ...
  flame: base({
    ...
    typewriter: { reveal: "scale", stagger: 0.035, charDuration: "0.28s" },
    ...
    sceneElements: [{
      // big bright sparks (yellow/white core, strong glow)
      shape: "svg",
      svgPath: "M20,18 C21.1,18 22,18.9 22,20 C22,21.1 21.1,22 20,22 C18.9,22 18,21.1 18,20 C18,18.9 18.9,18 20,18 Z",
      svgViewBox: "0 0 40 40",
      fill: "#fff8c0",
      filter: "drop-shadow(0 0 10px #ffd23f) drop-shadow(0 0 22px #ff7f30)",
      sizeRange: [6, 14], count: 22, spawnRate: 2.2,
      motion: { type: "rise", durationRange: [2.4, 4.0], sineAmplitude: 38, sinePeriod: 900 },
      selfAnim: { property: "scale", range: [0.6, 1.2], periodMs: 420 },
      opacityRange: [0.75, 1.0], blendMode: "screen",
    }, {
      // mid embers (orange tone)
      shape: "svg",
      svgPath: "M20,18 C21.1,18 22,18.9 22,20 C22,21.1 21.1,22 20,22 C18.9,22 18,21.1 18,20 C18,18.9 18.9,18 20,18 Z",
      svgViewBox: "0 0 40 40",
      fill: "#ff9040",
      filter: "drop-shadow(0 0 8px #ff7f30) drop-shadow(0 0 16px #ff3030)",
      sizeRange: [4, 9], count: 40, spawnRate: 4,
      motion: { type: "rise", durationRange: [2.0, 3.6], sineAmplitude: 30, sinePeriod: 700 },
      selfAnim: { property: "scale", range: [0.5, 1.1], periodMs: 360 },
      opacityRange: [0.6, 1.0], blendMode: "screen",
    }, {
      // tiny dust embers, fast & numerous
      shape: "svg",
      svgPath: "M20,18 C21.1,18 22,18.9 22,20 C22,21.1 21.1,22 20,22 C18.9,22 18,21.1 18,20 C18,18.9 18.9,18 20,18 Z",
      svgViewBox: "0 0 40 40",
      fill: "#ffd23f",
      filter: "drop-shadow(0 0 4px #ffd23f)",
      sizeRange: [2, 5], count: 70, spawnRate: 7,
      motion: { type: "rise", durationRange: [1.4, 2.5], sineAmplitude: 22, sinePeriod: 600 },
      selfAnim: { property: "scale", range: [0.4, 1.0], periodMs: 280 },
      opacityRange: [0.55, 1.0], blendMode: "screen",
    }],
  }),
  ...
  aqua: base({
    ...
    typewriter: { reveal: "blur", stagger: 0.07, charDuration: "0.7s" },
    entryKeyframes: k("fade", "slideUp", "emerge"),
    motionKeyframes: m("breathe", "drift", "sway"),
    bgKeyframes: bg("pulse", "drift"),
    bgCssVariants: [
  ...
  chaos: base({
    ...
    typewriter: { reveal: "shatter", stagger: 0.025, charDuration: "0.32s" },
